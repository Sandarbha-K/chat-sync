      ...
      <ToastMessage />
        <div className="flex items-center flex-col ">
          <div className="text-center">
            <div className="text-6xl mb-8 font-bold text-transparent bg-clip-text
           ...
           <div className="flex items-center gap-2 w-full mt-10 mb-5">
              <div className="bg-gradient-to-r from-indigo-500  via-sky-500 to-emerald-500 w-1/2 h-14 
                ...
                h-full rounded-md" onClick={signInWithGoogle}>
                    <IoLogoGoogle size={24} />
                    <span>Login with Google</span>
                </div>
               </div>

             <div className="bg-gradient-to-r from-indigo-500  via-purple-500 to-emerald-500 w-1/2 h-14 
           ...
           <form className="flex flex-col items-center gap-3 w-[500px] mt-5" onSubmit={handleSubmit}>
                 ...
                 />
                  ...
                  font-semibold bg-gradient-to-r from-indigo-500  via-sky-500 to-emerald-500">
                    Login to Your Account
                  </button>
           </form>
