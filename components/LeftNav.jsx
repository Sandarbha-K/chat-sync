...
const LeftNav = () => {
        ...
        <div className="relative flex flex-col items-center">
          ...
          <Icon 
            ...
            <div className="relative group cursor-pointer">
              ...
              <div className="w-full h-full rounded-full bg-black/[0.5] absolute top-0 left-0 justify-center
  ...
  return (
    <div className={`${editProfile ? "w-[350px]": " w-[80px] items-center"} flex flex-col justify-between py-5 
    shrink-0 transition-all`}>
      {editProfile ? editProfileContainer() :(
        ...
        <Avatar size="large" user={currentUser}/>
         <div className="w-full h-full rounded-full bg-black/[0.5] absolute top-0 left-0 
