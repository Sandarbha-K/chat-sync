...
const Composebar = () => {
    ...
    const onKeyUp=(e)=>{//for sending message while pressing enter
  ...
  return (
    <div className="flex items-center gap-2 grow">
        ...
        onKeyUp={onKeyUp}
        />
        <button className={`h-10 w-10 rounded-xl shrink-0 flex 
        justify-center items-center ${inputText.trim().length > 0?"bg-c4":""}`}
